...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cursorPeliculas = dbPeliculas.readableDatabase.query("peliculas", projectionPeliculas, selectionPeliculas, selectionArgsPeliculas, null, null, sortOrderPeliculas)
        ...
        val cursorSeries = dbSeries.readableDatabase.query("series", projectionSeries, selectionSeries, selectionArgsSeries, null, null, sortOrderSeries)
